...
$(function(){function i(){if(s){o=!0;var i=0,e=$("#posts-list").children().length,a=function(){i++;var r=e+i;return r>s.length-1?void t():void(l>i?n(r,a):o=!1)};n(e+i,a)}}function n(i,n){var t=s[i],o='<li><a href="'+t.url+'"><div class="posts-list-container"><img src="images/'+t.fimg+'"><div class="post-thumbnail-title"> <h3> <a href="+post.url+">'+t.title+"</a></h3><span>"+t.meta+"</span></div></div></a></li>";$("#posts-list").append(o),n()}function t(){e=!1,o=!1,$(".infinite-spinner").fadeOut()}var s,o=!1,e=!0,l=$("#posts-list").children().length,a=3e3;$(".infinite-spinner").length<1&&(e=!1),$(window).scroll(function(n){if(!s){var r="localhost"===window.location.hostname?"":"/my-awesome-site";$.getJSON(r+"/all-posts.json",function(i){s=i.posts,s.length<=l&&t()})}if(e&&!o){var c=$(window).height(),h=$(window).scrollTop(),f=c+h,d=$(document).height();f>d-a&&i()}})});
...
$(document).foundation(),$(".post-content").readingTime(),$(".menu-link").click(function(){$("#menu").toggleClass("active"),$(".container").toggleClass("active")}),$(document).ready(function(){function t(){maxHeight=Math.max.apply(Math,boxes.map(function(){return $(this).height()}).get()),boxes.height(maxHeight)}$(window).load(function(){boxes=$(".posts-list-img"),boxes&&t()}),$(window).resize(function(){boxes=$(".posts-list-img"),boxes&&(boxes.height("auto"),t())})});