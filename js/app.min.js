...
$(document).foundation(),$(".post-content").readingTime(),$(".menu-link").click(function(){$("#menu").toggleClass("active"),$(".container").toggleClass("active")}),$(document).ready(function(){function o(){maxHeight=Math.max.apply(Math,boxes.map(function(){return $(this).height()}).get()),boxes.height(maxHeight)}$(window).load(function(){boxes=$(".posts-list-img"),boxes&&o()}),$(window).resize(function(){boxes=$(".posts-list-img"),boxes&&(boxes.height("auto"),o())})});var postURLs,showRandomArticle=function(o){var t="localhost"===window.location.hostname?"":"/my-awesome-site";$.getJSON(t+"/all-posts.json",function(o){if(postURLs=o.posts,postURLs.length>0){var t=postURLs[Math.floor(Math.random()*postURLs.length+1)].url;window.location.href=t}})};